  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        floatingWidth ??= mediaQuery.size.width / 5;
                      ...
                      Positioned(
                        ...
                        child: IconButton(
                          ...
                          onPressed: (){
                            ...
                            // context.router.popUntilRouteWithName(HomeRouter.name);
                            // Navigator.of(context).popUntil((route) => route.navigator.);
                            Navigator.of(context, rootNavigator: true).pushReplacement(MaterialPageRoute(builder: (_) => HomeScreen()));
                          },
